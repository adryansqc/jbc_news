                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 font-weight-bold">Kategori: Peluang Usaha</h4>
                            </div>
                        </div>
                        @forelse($peluangUsaha as $berita)
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <a class="h4 d-block mb-3 text-secondary font-weight-bold" href="">{{ Str::limit($berita->judul, 50) }}</a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0">
                            <h4 class="m-0 font-weight-bold">Tranding News</h4>
                        </div>
