...
@section('content')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 font-weight-bold">Kategori: Perbankan</h4>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <a class="h4 d-block mb-3 text-secondary font-weight-bold" href="{{ route('frontend.beritaDetail', $berita->slug) }}">{{ Str::limit($berita->judul, 50) }}
                                    </a>
    ...
    <style>
/* ===== PERBANKAN - STYLING SELARAS DENGAN HOME ===== */
